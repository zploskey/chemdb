...
?>
    ...
    <tr>
        ...
        <td align="center"><input type=text name=icp_k[] value=<?=$an['icp_k']?> size=4></td>
        ...
        <td align="center"><?=sprintf('%.2f', $qtz_k[$a])?></td>

        <td align="left">
            <input type=text name=notes[] value="<?=$an['notes']?>">
        </td>
    </tr>
